...
export const ruTranslations: TranslationStructure = {
  ...
  dashboard: {
    ...
    manageAccount: 'Управляй своим аккаунтом и подпиской',
    overview: 'Обзор',
    profile: 'Профиль',
    ...
    setupProfile: 'Настрой свой игровой профиль',
    ...
    upgradeForFeatures: 'Обнови подписку для доступа к функциям',
    activeSubscription: 'Активная подписка',
    keyActivation: 'Активация ключа',
    keyPlaceholder: 'XXXXX-XXXXX-XXXXX-XXXXX',
    keyHint: 'Напиши лицензионный ключ для активации подписки',
    keyActivated: 'Ключ активирован!',
    keyNotFound: 'Ключ не найден',
    keyAlreadyUsed: 'Этот ключ уже был использован',
    enterKeyToActivate: 'Напиши ключ для активации',
    security: 'Безопасность',
    changePasswordDesc: 'Обнови пароль для защиты аккаунта',
    change: 'Изменить',
    ...
    enterKeyPlaceholder: 'Напиши ключ...',
    accountTab: 'Аккаунт',
    launcherTab: 'Лаунчер',
    friends: 'Друзья',
    soon: 'Скоро',
    ...
    addFriendDesc: 'Напиши имя друга',
    send: 'Отправить',
    theme: 'Тема',
    dark: 'Тёмная',
    light: 'Светлая',
    ...
    enterFriendUsername: 'Напиши имя друга...',
    ...
    noFriendsYet: 'Ты одинок',
    addFriendHint: 'Добавь друзей используя поле выше',
    removeFriend: 'Удалить из друзей',
    selectFriendToChat: 'Выбери друга для начала чата'
  },
  // Модальное окно оплаты
  payment: {
    title: 'Выбери способ оплаты',
    selectProduct: 'Выбери товар',
    selectPlaceholder: '-- Выбери товар --',
    promo: 'Промокод (необязательно)',
    promoPlaceholder: 'Напиши промокод',
    toPay: 'К оплате',
  ...
  auth: {
    ...
    enterLoginOrEmail: 'Напиши логин или email',
    password: 'Пароль',
    enterPassword: 'Напиши пароль',
    rememberMe: 'Запомнить меня',
    loginBtn: 'Войти',
    username: 'Логин',
    createUsername: 'Придумай логин',
    email: 'Email',
    enterEmail: 'Напиши email',
    ...
    verificationSent: 'Мы отправили 6-значный код на твою почту. Напиши его ниже:',
    confirm: 'Подтвердить',
    verifying: 'Проверка...',
    resendCode: 'Отправить код повторно',
    enterFullCode: 'Напиши полный код',
    ...
    forgotPasswordDesc: 'Введите email для получения кода сброса',
    enterCodeDesc: 'Мы отправили 6-значный код на вашу почту',
    newPasswordDesc: 'Создайте новый пароль для аккаунта',
    ...
    codeSentToEmail: 'Код отправлен на email',
    codeVerified: 'Код подтвержден',
    passwordChanged: 'Пароль успешно изменен!',
    backToLogin: 'Вернуться к входу',
    // Password validation
    passwordTooCommon: 'Этот пароль слишком распространённый. Выберите более надёжный.',
    passwordTooShort: 'Пароль должен содержать минимум 8 символов.',
    passwordRepeatingDigits: 'Пароль не может состоять из повторяющихся цифр.',
    passwordSimpleSequence: 'Пароль не может быть простой последовательностью.',
    passwordNeedsLetterAndNumber: 'Пароль должен содержать хотя бы одну букву и одну цифру.'
  },
  // Товары
  products: {
  ...
  devteam: {
    members: {
      nihmadev: {
        ...
        description: 'Разработчик сайта, лаунчера, бэкэнда, фронтенда и сервера. Иногда помогает с разработкой самого чита.'
      },
      dkdajw: {
        name: 'DKdajw',
