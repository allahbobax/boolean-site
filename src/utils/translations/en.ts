...
export const enTranslations: TranslationStructure = {
  ...
  hero: {
    title: 'Welcome to XiSe DLC',
    subtitle: "Don't just play the game. Bend its rules, break its limits, and redefine the experience.",
    cta: 'Products  ',
  ...
  auth: {
    ...
    enterCodeDesc: 'We sent a 6-digit code to your email',
    ...
    passwordRepeatingDigits: 'Password cannot consist of repeating digits.',
  ...
  products: {
    ...
    alpha: 'ALPHA 1.21.4',
    alphaDesc: 'Client for version 1.21.4',
  ...
  devteam: {
    members: {
      nihmadev: {
        ...
        description: 'Developer of the website, launcher, backend, frontend and server. Sometimes helps with the cheat development itself.'
      },
      dkdajw: {
        name: 'DKdajw',
